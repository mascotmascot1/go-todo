...
* **Релизы:** Сборка кроссплатформенных бинарных файлов (Windows/Linux) для быстрого запуска без Docker.
---
...
<details>
<summary><b>🛠 Ручной запуск тестов с авторизацией (подробно)</b></summary>
...
Frontend (веб-интерфейс), расположенный в директории `web/`, был предоставлен в рамках учебного курса и используется в проекте без изменений.

Backend-часть приложения реализована самостоятельно.

При повторном использовании или распространении frontend-части отдельно убедитесь, что это не нарушает условия использования оригинальных материалов курса.
